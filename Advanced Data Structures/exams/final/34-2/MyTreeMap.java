...
public class MyTreeMap<K,V> implements MySortedMap<K,V>, java.io.Serializable
{
	...
	private int mapSize;
	private MySet<K> ks;
	private MySet<MyMap.Entry<K,V>> es;
			...
			es = new MySet<MyMap.Entry<K,V>>()
				{
					...
					public boolean contains(Object item)	
					{
						...
						MyMap.Entry<K,V> entry = (MyMap.Entry<K,V>)item;
	...
	// Return: A string representation of this Map, which is a comma separated 
	//		   list of elements in the form key=value in ascending order of 
	//		   their keys enclosed in curly braces.
	public String toString()
	{
		String s = "[";
