...
public class MyHashMap<K,V> implements MyMap<K,V>, java.io.Serializable, Cloneable
{
    ...
    public Object clone()
    {
        ...
        {
            Entry<K,V> copyEntry = null;

            if (this.table[i] != null)
            {
                copyEntry = this.table[i];
                Entry<K,V> nextEntry = this.table[i].next;

                while (nextEntry != null)
                {
                    copyEntry.next = nextEntry;

                    copyEntry = copyEntry.next;
                    nextEntry = nextEntry.next;
                }
            }

            copy.table[i] = copyEntry;
        }
