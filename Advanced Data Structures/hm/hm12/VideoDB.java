...
public class VideoDB
{
    ...
    {
        MyTreeMap<String, Integer> copy = new MyTreeMap<>();

        while (!inventory.isEmpty())
        {
            String title = inventory.firstKey();
            Integer copies = inventory.get(title);
            System.out.println("   " + title +":"+ copies);
            
            copy.put(title, copies);
            inventory.remove(title);
        }

        while (!copy.isEmpty())
        {
            String title = copy.firstKey();
            Integer copies = copy.get(title);
