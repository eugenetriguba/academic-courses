...
public class MyLinkedList <T> implements MyList<T>, Cloneable, Serializable, Iterable<T>
{
    ...
    /**
     * Retrieves an iterator to iterate over this 
     * MyLinkedList
     * 
     * @return an iterator for this MyLinkedList
     */
    ...
    /**
     * Implements a iterator for this MyLinkedList
     */
    protected class MyLinkedListIterator implements Iterator<T>
    {
        private DNode<T> lastReturned;
        private DNode<T> nextNode;

        /**
         * Initializes this MyLinkedListIterator
         *
         * Post: lastReturned is set to null.
         *       nextNode is set to the second node (first data node)
         */
        public MyLinkedListIterator()
        {
            this.lastReturned = null;
            this.nextNode = MyLinkedList.this.nodeAtIndex(1);
        }

        /**
         * Determines whether there are more items in this list
         *
         * @return true if the next node's value is not null;
         *         false otherwise.
         */
        public boolean hasNext()
        {
            return this.nextNode.value != null;
        }

        /**
         * Retrieves the next item in the list.
         *
         * nextNode now points to the next element
         * and lastReturned is set to the node that
         * was just retrieved.
         *
         * @return the value of the next node
         * @throws NoSuchElementException if the end of the list has
         *                                been reached.
         */
        public T next()
        {
        ...
        /**
         * Removes the item from the list that was retrieved by next()
         * and sets lastReturned to null after removing the node.
         *
        ...
        public void remove()
        {
            ...
            MyLinkedList.this.remove(this.lastReturned);
            this.lastReturned = null;
        }
