...
// Time24.java
// A data structure that stores integer values for hour (0..23) 
// and minute (0..59) to represent the time of day in a 24-hour clock 
public class Time24 implements Comparable<Time24>, Serializable
{
    private int hour;
    private int minute;
    ...
    // Post: hour and minute of this Time24 object initialized to h 
    //       and m respectively. This operation will normalize the 
    //       time if necessary (e.g. 9:75 is stored as 10:15).
    ...
    // Pre:	h and m cannot be negative
    // Post: hour and minute of this Time24 object set to h and m respectively. //       This operation will normalize the time if necessary (e.g. 9:75 
    //       is stored as 10:15).
    // Exceptn:Throws InvalidArgumentException if h or m is negative
    ...
    //       will normalize the time if necessary (e.g. 9:75 is stored 
    //       as 10:15).
    ...
    // Return: A positive int if this Time24 > t; a negative int if 
    //         this Time24 < t; 0 if this Time24 == t
