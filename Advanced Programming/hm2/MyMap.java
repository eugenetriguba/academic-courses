public interface MyMap<K,V>
{
	...
	//Return:	A MySet object of all the MyMap.Entry elements contained in this MyMap.  The MySet 
	//	is backed by the MyMap, so changes to the MyMap are reflected in the MySet, and vice-
	//	versa
