...
public class MyHashMap<K, V> implements MyMap<K, V>, java.io.Serializable, Cloneable {
    ...
    public Object clone() {
        ...
        copy.ks = null;
        copy.es = null;
        copy.tableThreshold = tableThreshold;
        copy.hashMapSize = 0;
            ...
            ks =
                    new MySet<K>() {
                        ...
                        public Object[] toArray() {
                            ...
                            for (int i = 0; i < arr.length; i++) arr[i] = iter.next();
                            return arr;
                        }
    ...
    private class IteratorImpl<T> implements Iterator<T> {
        ...
        public IteratorImpl() {
            if (hashMapSize == 0) {
                ...
                index = 0;
                while ((nextNode = table[index]) == null) index++;
            }
            lastReturned = null;
        }
